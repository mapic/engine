...
module.exports = api.geo = { 
    ...
    csv2carto : function (options, done) {

        // tilstandsklasser carto
        ...
        carto += '[zoom=12] { marker-width: 1   * @marker_size_factor; }\n';
        carto += '[zoom=13] { marker-width: 1   * @marker_size_factor; }\n';
        carto += '[zoom=14] { marker-width: 2   * @marker_size_factor; }\n';
        carto += '[zoom=15] { marker-width: 4   * @marker_size_factor; }\n';
        carto += '[zoom=16] { marker-width: 6   * @marker_size_factor; }\n';
        carto += '[zoom=17] { marker-width: 8   * @marker_size_factor; }\n';
        carto += '[zoom>=18] { marker-width: 12  * @marker_size_factor; }\n';
    ...
    buildCarto_pointColor : function (options) {
        ...
        if ( color.column ) {
            ...
            // create color array with 17 colors
    ...
    createColorArray : function (fiveColors) {
        ...
        // return same array if already at 17 or more
        if (_.size(fiveColors) >= 17) return fiveColors;
